...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// </summary>
        /// <remarks>
        /// LoadBalancingroom Client is not aware of the Photon Offline Mode, so never use PhotonNetwork.NetworkingClient.CurrentRoom will be null if you are using OffLine Mode, while PhotonNetwork.CurrentRoom will be set when offlineMode is true
        /// </remarks>
